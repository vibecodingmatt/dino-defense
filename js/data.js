...
const CHANGELOG = [
  {v: '1.75.0', date: 'Sep 14, 2026', items: [
    '🏆 Claim a worldwide top-50 score with your three-character arcade name, and browse every zone from the homepage.',
    ...
    '📖 Hold a weapon in the armory to read its description, price, and upgrades on phones and tablets.',
  ]},
  ...
  {v: '1.68.0', date: 'Sep 12, 2026', items: [
    ...
    '🏝️ A cinematic home makeover adds easier menus, richer zones, a weathered outhouse, and a crackling electric fence.',
    '🔗 Share the adventure with a dramatic T-Rex preview and an easy game-link sharing button.',
